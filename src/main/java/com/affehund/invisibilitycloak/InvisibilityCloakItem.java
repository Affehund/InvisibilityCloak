...
public class InvisibilityCloakItem extends Item implements Wearable {
    ...
    public void inventoryTick(ItemStack stack, World world, Entity entity, int itemSlot, boolean selected) {
        if(entity instanceof PlayerEntity playerEntity && ModUtils.hasCloak(playerEntity)) {
            playerEntity.addStatusEffect(new StatusEffectInstance(StatusEffects.INVISIBILITY, 20, 0, false, false, false));
        }
    }
